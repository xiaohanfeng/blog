<?php /*a:4:{s:55:"E:\WWW\phpPro\phpblog\app\admin\view\content\index.html";i:1634805083;s:48:"E:\WWW\phpPro\phpblog\app\admin\view\layout.html";i:1634266574;s:48:"E:\WWW\phpPro\phpblog\app\admin\view\header.html";i:1634266318;s:48:"E:\WWW\phpPro\phpblog\app\admin\view\footer.html";i:1641541448;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    layui.use('table', function(){
        ...
        table.on('edit(datalist)', function(obj){
            ...
            $.ajax({
                url:'/admin/deal/edit?table=article',
                dataType:'json',
                type:'POST',
                data:container,
           ...
           // console.log(obj);
            ...
            switch(obj.event){
                case 'delData':
                    ...
                    break;
                case 'add':
                    window.open('/admin/content/post');
                    break;
            };
        });
        ...
        table.on('tool(datalist)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                window.open('/admin/content/post?artid='+data.id);
            }
        });
