...
;layui.define("form", function (e) {
    ...
    b.prototype.config = {
        ...
        isJump: !1,
        edit: !1,
        limitNodeAddLevel:0, //设置第X节点不允许添加操作 --wucs
        limitNodeDelLevel:0, //设置第X节点不允许删除操作 --wucs
        ...
        layui.each(r, function (a, r) {
            var l = r.children && r.children.length > 0,
                ...
                h = i(['<div data-id="' + r.id + '" class="layui-tree-set' + (r.spread ? " layui-tree-spread" : "") + (r.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
                    ...
                    //---wucs start
                    //设置第X节点不允许添加操作
                    if(t.limitNodeAddLevel >0 && r.level >= t.limitNodeAddLevel){
                        var e = {
                            update: '<i class="layui-icon layui-icon-edit" data-type="update"></i>',
                            del: '<i class="layui-icon layui-icon-delete" data-type="del"></i>'
                        }, i = ['<div class="layui-btn-group layui-tree-btnGroup">'];
                    ...
                    //设置第X节点不允许删除操作
                    if(t.limitNodeDelLevel >0 && r.level == t.limitNodeDelLevel){
                        var e = {
                            add: '<i class="layui-icon layui-icon-add-1"  data-type="add"></i>',
                        }, i = ['<div class="layui-btn-group layui-tree-btnGroup">'];
                    }
